    ...
    <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
      ...
      <tr><td style="padding:40px;">
        ...
        <p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:#444;">
          Você foi convidado para acessar o <strong>${realmName}</strong>.
          Clique no botão abaixo para criar sua senha e ativar sua conta.
        </p>
        <p style="text-align:center;margin:32px 0;">
          <a href="${link}" style="background:#6366f1;color:#fff;padding:14px 32px;border-radius:8px;text-decoration:none;font-weight:600;font-size:15px;display:inline-block;">Ativar minha conta</a>
        </p>
        <p style="margin:0 0 8px;font-size:13px;color:#888;">Este link expira em ${linkExpirationFormatter(linkExpiration)}.</p>
        <p style="margin:0;font-size:13px;color:#888;">Se você não esperava esse convite, pode ignorar este email com segurança.</p>
      </td></tr>

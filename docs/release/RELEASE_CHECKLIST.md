...
| 1.3 | `KNOWN_LIMITATIONS.md` has zero **Critical** entries; all **High** entries have an explicit "ship in 0.2.0 / slip to 0.2.x" decision. | release-prep | [KNOWN_LIMITATIONS.md §7](../roadmap/KNOWN_LIMITATIONS.md#7-summary-by-severity) |
...
| # | Gate | Owner | Evidence |
|---|------|-------|----------|
| 2.3.1 | Smoke pass exits with **PASS WITH GAPS**; every tab loads; tokens exchange via PKCE. | smoke | [SMOKE_TEST_v0.2.md §1](../validation/SMOKE_TEST_v0.2.md#1-result-summary), screenshots `01..09_*.png` |
...
| 2.4.3 | The 9 contract-changing tests enumerated in [INVITATION_RELIABILITY_v0.2.md §"Test coverage"](../validation/INVITATION_RELIABILITY_v0.2.md#test-coverage-for-the-new-contract) all exist and pass. | identity | grep + test runner |
